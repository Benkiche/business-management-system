    ...
    <div class="col-lg-4">
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between mb-2"><span>Discount</span><strong>-${{ number_format($sale->discount_amount, 2) }}</strong></div>
                <div class="d-flex justify-content-between mb-3"><span>Tax</span><strong>${{ number_format($sale->tax_amount, 2) }}</strong></div>
                <hr>
                <div class="d-flex justify-content-between mb-2"><span class="fw-semibold">Grand Total</span><strong>${{ number_format($sale->grand_total, 2) }}</strong></div>
                <div class="d-flex justify-content-between mb-2"><span>Paid</span><span class="text-success">${{ number_format($sale->amount_paid, 2) }}</span></div>
                <div class="d-flex justify-content-between"><span>Outstanding</span><strong class="{{ $sale->outstanding_balance > 0 ? 'text-danger' : 'text-success' }}">${{ number_format($sale->outstanding_balance, 2) }}</strong></div>
            </div>
        </div>
